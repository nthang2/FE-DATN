export type IdlAmmV3 = {
    ...
    instructions: [
        ...
        },
        {
            ...
            docs: ['Update pool status for given vaule', '', '# Arguments', '', '* `ctx`- The context of accounts', '* `status` - The vaule of status', ''];
            accounts: [
                {
                    name: 'authority';
                    isMut: false;
        ...
        },
        {
            ...
            docs: ['Creates an operation account for the program', '', '# Arguments', '', '* `ctx`- The context of accounts', ''];
            accounts: [
                {
                    name: 'owner';
                    isMut: true;
        ...
        },
        {
            ...
            docs: ['Transfer reward owner', '', '# Arguments', '', '* `ctx`- The context of accounts', '* `new_owner`- new owner pubkey', ''];
            accounts: [
                {
                    name: 'authority';
                    isMut: false;
        ...
        },
        {
            ...
            docs: ['Collect remaining reward token for reward founder', '', '# Arguments', '', '* `ctx`- The context of accounts', '* `reward_index` - the index to reward info', ''];
            accounts: [
                {
                    name: 'rewardFunder';
                    isMut: false;
        ...
        },
        {
            ...
            docs: ['Update rewards info of the given pool, can be called for everyone', '', '# Arguments', '', '* `ctx`- The context of accounts', ''];
            accounts: [
                {
                    name: 'poolState';
                    isMut: true;
        ...
        },
        {
            ...
            accounts: [
                ...
                },
                {
                    ...
                    isMut: true;
                    isSigner: false;
                    docs: ['Token account where position NFT will be minted', 'This account created in the contract by cpi to avoid large stack variables'];
                },
                {
            ...
            type: {
                ...
                fields: [
                    ...
                    },
                    {
                        ...
                        docs: ['The fee growth as a Q64.64 number, i.e. fees of token_0 and token_1 collected per', 'unit of liquidity for the entire life of the pool.'];
                        type: 'u128';
                    },
                    {
    ...
    types: [
        ...
        },
        {
            ...
            type: {
                ...
                fields: [
                    ...
                    {
                        name: 'liquidityNet';
                        docs: ['Amount of net liquidity added (subtracted) when tick is crossed from left to right (right to left)'];
                        type: 'i128';
                    },
                    {
                        name: 'liquidityGross';
        ...
        },
        {
            name: 'TickArryBitmap';
            type: {
                kind: 'struct'; // Change "alias" to a valid `kind` if needed
                fields: [{ name: 'array'; type: { array: ['u64', 8] } }];
            };
        }
    ];
    events: [
...
export const idlAmmV3: IdlAmmV3 = {
    version: '0.1.0',
    name: 'amm_v3',
    instructions: [
        {
