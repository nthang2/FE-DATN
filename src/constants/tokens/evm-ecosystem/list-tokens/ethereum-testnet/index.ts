...
export const ethEthereumTestnet = new EthereumChainTokenInfo({
  address: '0xeth',
  decimals: 18,
...
export const usdcEthereumTestnet = new EthereumChainTokenInfo({
...
export const bnbEthereumTestnet = new EthereumChainTokenInfo({
...
export const usdaiEthereumTestnet = new EthereumChainTokenInfo({
