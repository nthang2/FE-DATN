...
export async function getMyPortfolioUniversal(userAddress: string, chainId: string): Promise<MyPortfolioInfo> {
  const resp = await axios.get(apiUrl.getMyPortfolioUniversal(userAddress, chainId));
